...
import { buildApiUrl, modelCapabilityHeaders, resolveModelRequestConfigForCapability, type AiConfig } from "@/stores/use-config-store";
...
export async function requestAudioGeneration(config: AiConfig, prompt: string, options?: RequestOptions): Promise<Blob> {
    const requestConfig = resolveModelRequestConfigForCapability(config, "audio");
