...
export async function hydrateNodeGenerationContext(context: NodeGenerationContext) {
    ...
    return {
        ...
        referenceVideos: await Promise.all(context.referenceVideos.map(async (video) => ({ ...video, url: await mediaToDataUrl({ url: video.url, storageKey: video.storageKey, mimeType: video.type }) }))),
    };
}
