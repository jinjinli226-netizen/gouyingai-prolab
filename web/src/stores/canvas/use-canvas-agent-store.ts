...
export const CANVAS_AGENT_STORAGE_KEYS = {
    panelWidth: "gouyingai:canvas_agent_panel_width",
    url: "gouyingai:canvas_agent_url",
    token: "gouyingai:canvas_agent_token",
} as const;
...
export const useCanvasAgentStore = create<CanvasAgentStore>((set, get) => ({
    width: typeof window === "undefined" ? 440 : Number(localStorage.getItem(CANVAS_AGENT_STORAGE_KEYS.panelWidth)) || 440,
    url: typeof window === "undefined" ? "http://127.0.0.1:17371" : localStorage.getItem(CANVAS_AGENT_STORAGE_KEYS.url) || "http://127.0.0.1:17371",
    token: typeof window === "undefined" ? "" : localStorage.getItem(CANVAS_AGENT_STORAGE_KEYS.token) || "",
    connected: false,
    enabled: false,
    prompt: "",
    attachments: [],
