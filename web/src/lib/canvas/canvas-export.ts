...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = "ProCanvas") {
    ...
    const data: CanvasExportFile = { app: "gouyingai", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
